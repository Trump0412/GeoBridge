...
export GEOBRIDGE_STAGE2_MODEL_PATH="${MODEL_PATH:-${QWEN3VL_2B_PATH:-/mnt/guojh/lq/new/models/Qwen/Qwen3-VL-2B-Instruct}}"
export MODEL_PATH="${GEOBRIDGE_STAGE2_MODEL_PATH}"
export VARIANT_NAME="${VARIANT_NAME:-qwen3vl_2b_geobridge_hgb_layers0246}"
